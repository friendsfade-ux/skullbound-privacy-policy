...
This local save data stays on your device and is not sent to IronFade Studios.
...
IronFade Studios does not directly collect private personal information for advertising. However, Google AdMob may collect and use certain information through its advertising services, such as device identifiers, advertising ID, app activity, ad interactions, diagnostic information, approximate location based on IP address, and other technical information.

Google may use this information to show ads, measure ad performance, prevent fraud, and improve its advertising services. AdMob handles this information according to Google’s own privacy policies and advertising terms.
